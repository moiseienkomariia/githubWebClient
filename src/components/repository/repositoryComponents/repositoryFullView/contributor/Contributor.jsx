                ...
                hasError ?
                    ...
                    <div className={style.contributor}>
                        <div className={style.login}>
                            <img style={{borderRadius:"50%"}} width="25px" height="25px" src={contributor.avatar_url}
                                 alt="contributor"/>
                            <span className={style.login}>{contributor.login}</span>
                        </div>
                        <a className={style.btn} href={contributor.html_url} target="_blank">
